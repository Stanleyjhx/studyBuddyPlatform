  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const res = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}:${process.env.REACT_APP_BACKEND_PORT}/group_detail/get_group_members/${groupId}?limit=0&offset=10`,
        config
      );
      setMembers(res.data.data.group_members);
      setCachedData(res.data.data.group_members);
    };
    fetchData();
  }, []); 
